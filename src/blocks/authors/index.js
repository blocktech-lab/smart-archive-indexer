    ...
    edit: ({attributes, setAttributes}) => {
        ...
        return (
            <div {...useBlockProps()}>
                <Disabled>
                    <ServerSideRender
                        block="smartarchiveindexer/authors"
                ...
                <InspectorControls key="settings">
                    ...
                    <PanelBody title={__('Author Avatar', 'smartarchiveindexer')}>
                        <ToggleControl
                            label={__('Show Author Avatar', 'smartarchiveindexer')}
                            checked={attributes.avatar}
                            onChange={(value) => setAttributes({avatar: value})}
                        />
                        <RangeControl
                            label={__('Avatar Size', 'smartarchiveindexer')}
